<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('manage videos')
                        <x-nav-link href="{{ route('videos.manage.index') }}" :active="request()->routeIs('videos.manage.index')">
                            {{ __('Gestiona Vídeos') }}
                        </x-nav-link>
                    @endcan

                    @can('manage series')
                        <x-nav-link href="{{ route('series.manage.index') }}" :active="request()->routeIs('series.manage.index')">
                            {{ __('Gestionar Sèries') }}
                        </x-nav-link>
                    @endcan
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('manage videos')
                <x-responsive-nav-link href="{{ route('videos.manage.index') }}" :active="request()->routeIs('videos.manage.index')">
                    {{ __('Gestiona Vídeos') }}
                </x-responsive-nav-link>
            @endcan

            @can('manage series')
                <x-responsive-nav-link href="{{ route('series.manage.index') }}" :active="request()->routeIs('series.manage.index')">
                    {{ __('Gestionar Sèries') }}
                </x-responsive-nav-link>
            @endcan
        </div>
